...
knitr::kable(get_performance_metrics(LinearLikeBiasBasedModel),
             caption = "Results for the Linear Like model")
```
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(RatingNaiveBayes),
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(RF_Rec),
             caption = "Results for the RF based model")
```
