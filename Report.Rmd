...
and on or after that values in $\{1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5\}$ are allowed.
The folowing function performs such rounding:
...
the results in a dataset, which can be included as a table in this document.
