...
of this project.
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(edx, validation, RFNaiveBayesModel),
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(edx, validation, RFRecModel),
...
$R_{U \times M}$ (assuming that $U$ the number of users and $M$ the number of movies) as the product of two matrices of lower dimension $P_{U \times K}$ and 
$Q_{M \times K}$. 
...
$K$ would be the number of (latent) factors,
in this way $P$ would indicate the amount associated of each one of the factors 
per customer, and $Q$ similarly indicates the amount of each one of the factors
per movie.
