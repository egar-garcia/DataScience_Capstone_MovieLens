...
eval_ResidualsMatrixFactorizationModel <- !exists('results_ResidualsMatrixFactorizationModel')
```
...
```{r constructor_ResidualsMatrixFactorizationModel, echo=FALSE, eval=eval_ResidualsMatrixFactorizationModel}
...
results_ResidualsMatrixFactorizationModel <-
    get_performance_metrics('Residuals Matrix Factorization', edx, validation, ResidualsMatrixFactorizationModel)
```
