...
(actually for this project small subset of 10M is used).
In the scope of this project by recomendation we understand the action of
predicting the rating that a particular user gives to a particular movie. 


As a part of this project a trininig and validation sets are given 
(actually an R script has been given to generate them).
...
ratings ending with a half star are used, at first impression looks like
