...
```{r results = 'asis'}
knitr::kable(get_performance_metrics(edx, validation, ModeModel),
...
knitr::kable(get_performance_metrics(edx, validation, AvgModel),
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(edx, validation, LinearLikeBiasBasedModel),
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(edx, validation, RatingNaiveBayes),
             caption = "Results for the naive-Bayes based model")
```
...
```{r results = 'asis', echo=FALSE}
knitr::kable(get_performance_metrics(edx, validation, RF_Rec),
             caption = "Results for the RF-Rec based model")
```
